...
1. [Direct S3 Access GEDI L4A from the NASA EarthData Cloud](notebooks/gedi_l4a_direct_s3_access.ipynb): retrieve the GEDI L4A dataset from NASA Earthdata Cloud using direct S3 access.
